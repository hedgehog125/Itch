...
function stageIcon() {
	...
	CanvasController.drawImage(stageImgs["IMGs"][stageImgs["Selected"]]["IMG"],1,78,10,8)
	if (SelectedSprite == "Stage") {
...
function background() {
	...
	var stageImgs = Project["Stage"]["Imgs"]
	CanvasController.drawImage(stageImgs["IMGs"][stageImgs["Selected"]]["IMG"],0,0,100,75)
}
